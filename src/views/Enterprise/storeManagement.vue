    ...
    <div class="subpage-content">
      ...
      >
        <div class="modal-body">
          <a-form-model :model="form2" :rules="checkRules" ref="form2" style="width:360px" :labelCol="{span:7}" :wrapperCol="{span:17}">
      ...
      <a-modal
        ...
        <div class="modal-body">
          <a-form-model style="width:360px" :rules="checkNewRules" :model="checkNew" ref="checkNew" :labelCol="{span:7}" :wrapperCol="{span:17}">
            <a-form-model-item  label="渠道名称">
        ...
        <div class="modal-body">
          ...
          <div class="table-area" style="width:100%;margin-top:30px">
            <a-table
              ...
              >
                <a-button style="color:#0F79F9;cursor:pointer;">删除</a-button>
              </a-popconfirm>
            </span>
              <!-- 用表格的footer来添加视光师 -->
