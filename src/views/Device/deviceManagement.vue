    ...
    <div class="subpage-content">
      ...
      <div style="margin-bottom: 15px;">
        ...
        <a-modal class="modal-430" title="新建设备"
                  ...
                  width="400px"
                  centered
                  @ok="() => setModalNewVisible(false,true,'buildDevice')"
            ...
            <div class="modal-body">
                <a-form-model
                    ...
                    <a-form-model-item has-feedback
                                       prop="deviceVersion" label="硬件版本">
                        <a-input v-model.number="buildDevice.deviceVersion"
                                  style="width: 240px"/>
                    </a-form-model-item>
...
<script>
    ...
    export default {
        ...
        data() {
            let checkPending;
            let checkDeviceVersion = (rule, value, callback) => {
            ...
            return {
                ...
                state: '',
                rules: {
                    deviceVersion: [{ validator: checkDeviceVersion, trigger: 'change' }],
                },
            };
        },
        computed: {
        ...
        methods:{
            ...
            setModalNewVisible(modalNewVisible,Pflag,formName) {
