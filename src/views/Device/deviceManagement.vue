  ...
  <div class="subpage-layout">
    ...
    <div class="subpage-content">
      ...
      <div style="margin-bottom: 15px;">
        ...
        <div style="width:250px;position:relative;top:-40px;">
            <span>每页显示</span>
        ...
        <a-modal title="新建设备"
                  ...
                  cancelText="关闭"
                  okText="提交"
                  :maskStyle="{'background-color':'rgba(0,0,0,0.33)'}">
        ...
        <a-modal title="分配设备"
                    ...
                    cancelText="关闭"
                    okText="提交"
                    :maskStyle="{'background-color':'rgba(0,0,0,0.1)'}">
            <div class="modal-body">
                <!--                        <div>-->
                <!--                            :rules="ruleOne"-->
                <!--                            ref="ruleForm"-->
                ...
                <a-form-model
                    ...
                    <a-form-model-item label="启用时间">
                        <a-input v-model="distributeDevice.Stime" style="width: 240px"/>
                    </a-form-model-item>
                </a-form-model>
            </div>
        </a-modal>
        <a-modal title="查看"
                    ...
                    cancelText="关闭"
                    okText="提交"
                    :maskStyle="{'background-color':'rgba(0,0,0,0.05)'}">
            <div class="modal-body">
                <a-form-item
                        label="设备信息"
                        :labelCol="{span:5}"
                        :wrapperCol="{span:19}">
                    <a-card>
                        <p><span style="font-weight:bold">设备编号: </span>{{ look.deviceNumber }}</p>
                        <p><span style="font-weight:bold">设备名: </span>{{ look.deviceName }}</p>
                        <p><span style="font-weight:bold">设备类型: </span>{{ look.deviceType }}</p>
                        <p><span style="font-weight:bold">硬件版本: </span>{{ look.version }}</p>
                        <p><span style="font-weight:bold">蓝牙标识: </span>{{ look.blueTeethID }}</p>
                        <p><span style="font-weight:bold">状态: </span>{{ look.state }}</p>
                        <p><span style="font-weight:bold">分配渠道: </span>{{ look.channel }}</p>
                    </a-card>
    ...
    const data = [
        {
            ...
            deviceType:'打印机',
            version:12,
            blueTeethID:'120111199909099090',
            state:'启用',
