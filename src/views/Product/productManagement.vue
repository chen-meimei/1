        ...
        <a-table style="width:100%;height:100%"
          ...
          <template slot="action" slot-scope="text,record,index">
            <div class="action-btn-layout" style="margin:0 auto;display:flex;justify-content:space-around">
              ...
              <a-button type="primary" style="padding:0 15px;" @click="stopButton(record.key)" :id="record.key" v-if="record.state=='启用'" >停用</a-button>
              <a-button type="danger"  style="padding:0 15px;" @click="startButton(record.key)" :id="record.key" v-if="record.state=='停用'">启用</a-button>
            </div>
          </template>
        </a-table>
        <div style="width:250px;position:relative;top:-70px;">
          <span>每页显示</span>
